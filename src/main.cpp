...
const string strMessageMagic = "vibrantcoin Signed Message:\n";
...
static const int64_t nTargetTimespan = 24 * 60 * 60;  // 16 mins
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "vibrantcoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "14Jan2018";
        CTransaction txNew;
        txNew.nTime = 1515847144;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1515847144;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = !fTestNet ? 146952 : 146952;
        ...
        assert(block.hashMerkleRoot == uint256("0xa1999d894a4aa230f9f63a968cd385eff5812d245873eb062db80c911927592d"));
